...
public class PetStoreData {
	...
	private Set<PetStoreEmployee> employee = new HashSet<>();
	...
	public PetStoreData(PetStore petStore) {
		...
		for (Customer customer : petStore.getCustomer()) {
			this.customer.add(new PetStoreCustomer(customer));
		}

		for (Employee employee : petStore.getEmployees()) {
			this.employee.add(new PetStoreEmployee(employee));
		}
